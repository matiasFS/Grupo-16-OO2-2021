...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/home", "/gestion","/gestiondepermisos", "/crearpersona").permitAll()
				.antMatchers("/home", "/gestion","/gestiondepermisos", "/crearpersona", "/newrodado","/fecha","/buscarfecha").permitAll()
