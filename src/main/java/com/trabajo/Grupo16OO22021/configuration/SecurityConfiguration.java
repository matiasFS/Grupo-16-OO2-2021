...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/login", "/gestion", "/createperson", "/createrodado", "/newrodado", "/createpermisoperiodo", "/newpermiso", "/createpermisodiario", "/newpermisodiario", "/personas","/personas/crearpersona").permitAll()
